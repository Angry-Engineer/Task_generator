...
namespace Генератор_распоряжений
{
    ...
    public class Распоряжение_шаблон
    {
        ...
        public Распоряжение_шаблон(String Организация, String Структурная_единица, String Производитель_распоряжения, String Допускающий_распоряжения, String Бригада_распоряжения, String Задание_распоряжения, String Объект_распоряжения, String Расположение_распоряжения, String Условия_работы_распоряжения, String Источник_распоряжения)
        {
